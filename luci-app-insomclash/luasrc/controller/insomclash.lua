...
function index()
    entry({"admin", "services", "insomclash"}, alias("admin", "services", "insomclash", "home"), _("Insomclash"), 60)
    entry({"admin", "services", "insomclash", "home"}, template("insomclash/home"), _("Home"), 1)
    entry({"admin", "services", "insomclash", "dashboard"}, template("insomclash/dashboard"), _("Dashboard"), 2)
    entry({"admin", "services", "insomclash", "manager"}, template("insomclash/manager"), _("Manager"), 3)
    entry({"admin", "services", "insomclash", "converter"}, template("insomclash/converter"), _("Converter"), 4)
    entry({"admin", "services", "insomclash", "logs"}, template("insomclash/logs"), _("Logs"), 5)
    entry({"admin", "services", "insomclash", "editor"}, template("insomclash/editor"), nil)
    entry({"admin", "services", "insomclash", "edit_config"}, cbi("insomclash/config"), nil)
    entry({"admin", "services", "insomclash", "service_action"}, call("action_service"), nil)
    entry({"admin", "services", "insomclash", "get_logs"}, call("action_get_logs"), nil)
    entry({"admin", "services", "insomclash", "get_config"}, call("action_get_config"), nil)
    entry({"admin", "services", "insomclash", "set_config"}, call("action_set_config"), nil)
    entry({"admin", "services", "insomclash", "get_dashboard_info"}, call("action_get_dashboard_info"), nil)
    entry({"admin", "services", "insomclash", "load_editor_status"}, call("action_load_editor_status"), nil)
    entry({"admin", "services", "insomclash", "save_file"}, call("action_save_file"), nil)
    entry({"admin", "services", "insomclash", "load_file"}, call("action_load_file"), nil)
    entry({"admin", "services", "insomclash", "delete_file"}, call("action_delete_file"), nil)
    entry({"admin", "services", "insomclash", "upload_file"}, call("action_upload_file"), nil).leaf = true
    entry({"admin", "services", "insomclash", "create_file"}, call("action_create_file"), nil)
    entry({"admin", "services", "insomclash", "download_file"}, call("action_download_file"), nil)
    entry({"admin", "services", "insomclash", "backup_files"}, call("action_backup_files"), nil)
    entry({"admin", "services", "insomclash", "convert_proxy"}, call("action_convert_proxy"), nil)
end
